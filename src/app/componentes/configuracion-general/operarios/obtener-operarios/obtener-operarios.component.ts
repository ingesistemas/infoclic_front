...
@Component({
  selector: 'app-obtener-operarios',
  imports: [
    NgClass,
    MatButtonModule,
    MatDividerModule,
  ...
  templateUrl: './obtener-operarios.component.html',
  styleUrl: './obtener-operarios.component.css',
  providers: [MessageService],
})
export class ObtenerOperariosComponent {
  private fb = inject(FormBuilder)
    ...
    nuevo(){
      ...
      this.router.navigateByUrl('/infoclic/configuracion-general/crear-operario')
    }
    ...
    editar(objeto: any){
      ...
      this.router.navigate(['/infoclic/configuracion-general/crear-operario'], {
        state: { datos: objeto }
      });
    }
            ...
            if(data.Error == true){
              ...
              if(data.Data.length == 0){
                ...
                if(url == '/obtener-usuarios' || url == '/obtener-usuarios-sucursal'){
                  ...
                  this.dataSource.data = this.operarios
                  this.dataSource.paginator = this.paginator;
                  this.dataSource.sort = this.sort;
                  
                }else if(url == '/activo-usuario'){
