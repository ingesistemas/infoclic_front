...
@Component({
  selector: 'app-crear-editar-centros',
  imports: [ReactiveFormsModule, ToastModule],
  templateUrl: './crear-editar-centros.component.html',
  styleUrl: './crear-editar-centros.component.css',
  providers: [MessageService],
})
export class CrearEditarCentrosComponent {
  ...
  formulario = this.fb.group({
    id: [0],
    centro: ['' , [Validators.required, Validators.minLength(3)]],
  ...
  ngOnInit(): void {
    ...
    if(this.tamanioForm.accionActual() == 'Editar'){
      ...
      this.formulario.controls['centro'].setValue(datos.datos.centro)
    }
  }
  ...
  cerrar(){
    this.router.navigateByUrl('/infoclic/configuracion-general/centros')
  }
  ...
  aceptar(){
    if(this.accion == 'Crear'){
      this.peticion('/crear-centro')
    }else{
      this.peticion('/editar-centro')
    }
  }
